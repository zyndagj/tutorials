...
* `Docker <https://docs.docker.com/get-docker/>`_ for building containers
* `Base Command Platform <https://www.nvidia.com/en-us/data-center/base-command/>`_ for running the container on DGX Cloud
...
* `Try performance recommendations for fq2bam <https://docs.nvidia.com/clara/parabricks/latest/bestperformance.html#best-performance-for-fq2bam-fq2bamfast>`_
...
* `BioNeMo Geneformer <https://docs.nvidia.com/bionemo-framework/latest/notebooks/geneformer_cellxgene_tutorial.html>`_: inferencing for single cell downstream tasks